...
class RefinementMagNet(nn.Module):
    def __init__(self, n_classes, use_bn=False):
        ...
        # 2 conv layers
        self.conv1 = nn.Conv2d(n_classes*2, 64, kernel_size=3, stride=1, padding=1,
                               bias=False)
...
# class RefinementMagNet(nn.Sequential):
#     def __init__(self, n_classes, use_bn=False):
#         super().__init__()
#         self.use_bn = use_bn
#         if use_bn:
...
#         # Prediction head
#         self.seg_conv = nn.Conv2d(64, n_classes, kernel_size=1, stride=1, padding=0, bias=False)
